...
void LoadA3P250SetupArray(void)
{
	...
	int cal_cap, main_thresh, wil_thresh, hysteresis, wil_int, wil_cur, deadtime,
        ...
        channel5Mode, channel6Mode, channel7Mode, chipMode;
	
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL0, &basicSetupArray_a3p250[ASD0_CH0]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL1, &basicSetupArray_a3p250[ASD0_CH1]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL2, &basicSetupArray_a3p250[ASD0_CH2]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL3, &basicSetupArray_a3p250[ASD0_CH3]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL4, &basicSetupArray_a3p250[ASD0_CH4]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL5, &basicSetupArray_a3p250[ASD0_CH5]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL6, &basicSetupArray_a3p250[ASD0_CH6]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL7, &basicSetupArray_a3p250[ASD0_CH7]);
	


  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CALIBCAPACITOR, &cal_cap);
  IntToReversedBinary(cal_cap, ASD0_CAL_CAP, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_MAINTHRESHOLD, &main_thresh);
  main_thresh = (main_thresh + 254) / 2;
  IntToReversedBinary(main_thresh, ASD0_MAIN_THRESH, 8, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_THRESH, &wil_thresh); 
  IntToReversedBinary(wil_thresh, ASD0_WIL_THRESH, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_HYSTERESIS, &hysteresis); 
  IntToReversedBinary(hysteresis, ASD0_HYSTERESIS, 4, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_INT, &wil_int);
  IntToReversedBinary(wil_int, ASD0_WIL_INT, 4, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_CUR, &wil_cur);
  IntToReversedBinary(wil_cur, ASD0_WIL_CUR, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_DEADTIME, &deadtime);
  IntToReversedBinary(deadtime, ASD0_DEADTIME, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL0MODE, &channel0Mode);
  IntToReversedBinary(channel0Mode, ASD0_CHANNEL_MODE_0, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL1MODE, &channel1Mode);
  IntToReversedBinary(channel1Mode, ASD0_CHANNEL_MODE_1, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL2MODE, &channel2Mode);
  IntToReversedBinary(channel2Mode, ASD0_CHANNEL_MODE_2, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL3MODE, &channel3Mode);
  IntToReversedBinary(channel3Mode, ASD0_CHANNEL_MODE_3, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL4MODE, &channel4Mode);
  IntToReversedBinary(channel4Mode, ASD0_CHANNEL_MODE_4, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL5MODE, &channel5Mode);
  IntToReversedBinary(channel5Mode, ASD0_CHANNEL_MODE_5, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL6MODE, &channel6Mode);
  IntToReversedBinary(channel6Mode, ASD0_CHANNEL_MODE_6, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL7MODE, &channel7Mode);
  IntToReversedBinary(channel7Mode, ASD0_CHANNEL_MODE_7, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHIPMODE, &chipMode);
  IntToReversedBinary(chipMode, ASD0_CHIP_MODE, 1, basicSetupArray_a3p250, A3P250SETUP_LENGTH);


  
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL0, &basicSetupArray_a3p250[ASD1_CH0]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL1, &basicSetupArray_a3p250[ASD1_CH1]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL2, &basicSetupArray_a3p250[ASD1_CH2]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL3, &basicSetupArray_a3p250[ASD1_CH3]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL4, &basicSetupArray_a3p250[ASD1_CH4]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL5, &basicSetupArray_a3p250[ASD1_CH5]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL6, &basicSetupArray_a3p250[ASD1_CH6]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL7, &basicSetupArray_a3p250[ASD1_CH7]);
	


  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CALIBCAPACITOR, &cal_cap);
  IntToReversedBinary(cal_cap, ASD1_CAL_CAP, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_MAINTHRESHOLD, &main_thresh);
  main_thresh = (main_thresh + 254) / 2;
  IntToReversedBinary(main_thresh, ASD1_MAIN_THRESH, 8, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_THRESH, &wil_thresh); 
  IntToReversedBinary(wil_thresh, ASD1_WIL_THRESH, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_HYSTERESIS, &hysteresis); 
  IntToReversedBinary(hysteresis, ASD1_HYSTERESIS, 4, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_INT, &wil_int);
  IntToReversedBinary(wil_int, ASD1_WIL_INT, 4, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_CUR, &wil_cur);
  IntToReversedBinary(wil_cur, ASD1_WIL_CUR, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_DEADTIME, &deadtime);
  IntToReversedBinary(deadtime, ASD1_DEADTIME, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL0MODE, &channel0Mode);
  IntToReversedBinary(channel0Mode, ASD1_CHANNEL_MODE_0, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL1MODE, &channel1Mode);
  IntToReversedBinary(channel1Mode, ASD1_CHANNEL_MODE_1, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL2MODE, &channel2Mode);
  IntToReversedBinary(channel2Mode, ASD1_CHANNEL_MODE_2, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL3MODE, &channel3Mode);
  IntToReversedBinary(channel3Mode, ASD1_CHANNEL_MODE_3, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL4MODE, &channel4Mode);
  IntToReversedBinary(channel4Mode, ASD1_CHANNEL_MODE_4, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL5MODE, &channel5Mode);
  IntToReversedBinary(channel5Mode, ASD1_CHANNEL_MODE_5, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL6MODE, &channel6Mode);
  IntToReversedBinary(channel6Mode, ASD1_CHANNEL_MODE_6, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL7MODE, &channel7Mode);
  IntToReversedBinary(channel7Mode, ASD1_CHANNEL_MODE_7, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHIPMODE, &chipMode);
  IntToReversedBinary(chipMode, ASD1_CHIP_MODE, 1, basicSetupArray_a3p250, A3P250SETUP_LENGTH);  
  

  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL0, &basicSetupArray_a3p250[ASD2_CH0]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL1, &basicSetupArray_a3p250[ASD2_CH1]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL2, &basicSetupArray_a3p250[ASD2_CH2]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL3, &basicSetupArray_a3p250[ASD2_CH3]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL4, &basicSetupArray_a3p250[ASD2_CH4]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL5, &basicSetupArray_a3p250[ASD2_CH5]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL6, &basicSetupArray_a3p250[ASD2_CH6]);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL7, &basicSetupArray_a3p250[ASD2_CH7]);
	


  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CALIBCAPACITOR, &cal_cap);
  IntToReversedBinary(cal_cap, ASD2_CAL_CAP, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_MAINTHRESHOLD, &main_thresh);
  main_thresh = (main_thresh + 254) / 2;
  IntToReversedBinary(main_thresh, ASD2_MAIN_THRESH, 8, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_THRESH, &wil_thresh); 
  IntToReversedBinary(wil_thresh, ASD2_WIL_THRESH, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_HYSTERESIS, &hysteresis); 
  IntToReversedBinary(hysteresis, ASD2_HYSTERESIS, 4, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_INT, &wil_int);
  IntToReversedBinary(wil_int, ASD2_WIL_INT, 4, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_WIL_CUR, &wil_cur);
  IntToReversedBinary(wil_cur, ASD2_WIL_CUR, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_DEADTIME, &deadtime);
  IntToReversedBinary(deadtime, ASD2_DEADTIME, 3, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL0MODE, &channel0Mode);
  IntToReversedBinary(channel0Mode, ASD2_CHANNEL_MODE_0, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL1MODE, &channel1Mode);
  IntToReversedBinary(channel1Mode, ASD2_CHANNEL_MODE_1, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL2MODE, &channel2Mode);
  IntToReversedBinary(channel2Mode, ASD2_CHANNEL_MODE_2, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL3MODE, &channel3Mode);
  IntToReversedBinary(channel3Mode, ASD2_CHANNEL_MODE_3, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL4MODE, &channel4Mode);
  IntToReversedBinary(channel4Mode, ASD2_CHANNEL_MODE_4, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL5MODE, &channel5Mode);
  IntToReversedBinary(channel5Mode, ASD2_CHANNEL_MODE_5, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL6MODE, &channel6Mode);
  IntToReversedBinary(channel6Mode, ASD2_CHANNEL_MODE_6, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHANNEL7MODE, &channel7Mode);
  IntToReversedBinary(channel7Mode, ASD2_CHANNEL_MODE_7, 2, basicSetupArray_a3p250, A3P250SETUP_LENGTH);
  GetCtrlVal(ASDSetupHandle, P_ASDSETUP_CHIPMODE, &chipMode);
  IntToReversedBinary(chipMode, ASD2_CHIP_MODE, 1, basicSetupArray_a3p250, A3P250SETUP_LENGTH);  
}    
...
void LoadA3P250SetupArray(void)
{
	...
	basicReversedSetupArray_a3p250[ASD0_CHIP_MODE]=asd0_chip_mode;	
...
void LoadA3P250SetupArray(void)
{
	IntToBinary(asd0_vmon,ASD0_VMON,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_ch_mask_tst_ctrl,ASD0_CH_MASK_TST_CTRL,8,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_cap_select,ASD0_CAP_SELECT,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_main_thr_dac,ASD0_MAIN_THR_DAC,8,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_wilk_thr_dac,ASD0_WILK_THR_DAC,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_hyst_dac,ASD0_HYST_DAC,4,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_rund_curr,ASD0_RUND_CURR,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_int_gate,ASD0_INT_GATE,4,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	...
	IntToBinary(asd0_channel_7_mode,ASD0_CHANNEL_7_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_channel_6_mode,ASD0_CHANNEL_6_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_channel_5_mode,ASD0_CHANNEL_5_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_channel_4_mode,ASD0_CHANNEL_4_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);	
	IntToBinary(asd0_channel_3_mode,ASD0_CHANNEL_3_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_channel_2_mode,ASD0_CHANNEL_2_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_channel_1_mode,ASD0_CHANNEL_1_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd0_channel_0_mode,ASD0_CHANNEL_1_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);	
	
	
	
	IntToBinary(asd1_vmon,ASD1_VMON,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_ch_mask_tst_ctrl,ASD1_CH_MASK_TST_CTRL,8,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_cap_select,ASD1_CAP_SELECT,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_main_thr_dac,ASD1_MAIN_THR_DAC,8,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_wilk_thr_dac,ASD1_WILK_THR_DAC,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_hyst_dac,ASD1_HYST_DAC,4,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_rund_curr,ASD1_RUND_CURR,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_int_gate,ASD1_INT_GATE,4,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_deadtime,ASD1_DEADTIME,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	basicSetupArray_a3p250[ASD1_CHIP_MODE]=asd1_chip_mode;
	IntToBinary(asd1_channel_7_mode,ASD1_CHANNEL_7_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_channel_6_mode,ASD1_CHANNEL_6_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_channel_5_mode,ASD1_CHANNEL_5_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_channel_4_mode,ASD1_CHANNEL_4_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);	
	IntToBinary(asd1_channel_3_mode,ASD1_CHANNEL_3_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_channel_2_mode,ASD1_CHANNEL_2_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_channel_1_mode,ASD1_CHANNEL_1_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd1_channel_0_mode,ASD1_CHANNEL_1_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);	
	
	
	IntToBinary(asd2_vmon,ASD2_VMON,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_ch_mask_tst_ctrl,ASD2_CH_MASK_TST_CTRL,8,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_cap_select,ASD2_CAP_SELECT,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_main_thr_dac,ASD2_MAIN_THR_DAC,8,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_wilk_thr_dac,ASD2_WILK_THR_DAC,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_hyst_dac,ASD2_HYST_DAC,4,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_rund_curr,ASD2_RUND_CURR,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_int_gate,ASD2_INT_GATE,4,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_deadtime,ASD2_DEADTIME,3,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	basicSetupArray_a3p250[ASD2_CHIP_MODE]=asd2_chip_mode;
	IntToBinary(asd2_channel_7_mode,ASD2_CHANNEL_7_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_channel_6_mode,ASD2_CHANNEL_6_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_channel_5_mode,ASD2_CHANNEL_5_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_channel_4_mode,ASD2_CHANNEL_4_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);	
	IntToBinary(asd2_channel_3_mode,ASD2_CHANNEL_3_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_channel_2_mode,ASD2_CHANNEL_2_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_channel_1_mode,ASD2_CHANNEL_1_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);
	IntToBinary(asd2_channel_0_mode,ASD2_CHANNEL_1_MODE,2,basicSetupArray_a3p250, A3P250SETUP_LENGTH);	
