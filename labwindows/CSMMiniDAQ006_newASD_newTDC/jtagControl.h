...
#define A3P250ID						0x32A141CF   //new TDC mezz
...
int downloadTDCStatus[MAXNUMBERMEZZANINE],TDCOffset[MAXNUMBERMEZZANINE];
...
//for U of M MDT-TDC JTAG control
