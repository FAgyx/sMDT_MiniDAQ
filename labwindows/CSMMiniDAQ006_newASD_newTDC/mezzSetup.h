...
#define TDC_ASD_SETUP_LENGTH						165
//offset
...
#define  asd0_rund_curr            					0   
#define  asd0_int_gate             					3   
#define  asd0_deadtime             					7   
#define  asd0_chip_mode            					0   
...
#define  asd1_rund_curr            					0   
#define  asd1_int_gate             					3   
#define  asd1_deadtime             					7   
#define  asd1_chip_mode            					0   
...
#define  asd2_rund_curr            					0   
#define  asd2_int_gate             					3   
#define  asd2_deadtime             					7   
#define  asd2_chip_mode            					0   
...
int ASDSetupArray[ASD_SETUP_LENGTH];
...
#define TDC_ENABLE_NEW_TTC 						1
#define TDC_ENABLE_MASTER_RESET_CODE			1  
#define TDC_ENABLE_DIRECT_BUNCH_RESET			1
#define TDC_ENABLE_DIRECT_EVENT_RESET			1
#define TDC_ENABLE_DIRECT_TRIGGER				1
#define TDC_ENABLE_AUTO_ROLL_OVER				1				
#define TDC_BYPASS_BCR_DISTRIBUTION				1
#define TDC_ENABLE_TRIGGER						1			
#define TDC_CHANNEL_DATA_DEBUG					1				
#define TDC_ENABLE_LEADING						1			
#define TDC_ENABLE_PAIR							1		
#define TDC_ENABLE_FAKE_HIT						1			
#define TDC_RISING_IS_LEADING					0xFFFFFF			
//#define TDC_CHANNEL_ENABLE_R					0x000000
...
//#define TDC_CHANNEL_ENABLE_F					0x000000
#define TDC_CHANNEL_ENABLE_F					0xFFFFFF
#define TDC_INNER_ID							0x7FFFF
#define TDC_ENABLE_TRIGGER_TIMEOUT				1					
#define TDC_ENABLE_HIGH_SPEED					1			
#define TDC_ENABLE_LEGACY						1		
#define TDC_FULL_WIDTH_RES						1			
#define TDC_WIDTH_SELECT						7		
#define TDC_ENABLE_8B10B						1		
#define TDC_ENABLE_INSERT						1		
#define TDC_ENABLE_ERROR_PACKET					1				
#define TDC_ENABLE_ID							1	
#define TDC_ENABLE_ERROR_NOTIFY					1
