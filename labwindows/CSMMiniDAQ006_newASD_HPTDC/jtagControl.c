...
/////Do special setting for mezz#1(trigger digitization)				
/*
				if (i==1){
					basicSetupArray_a3p250[11]=0;
					basicSetupArray_a3p250[12]=1;
					basicSetupArray_a3p250[13]=0;
					basicSetupArray_a3p250[14]=0;
					basicSetupArray_a3p250[15]=1;
					basicSetupArray_a3p250[16]=0; 
					basicSetupArray_a3p250[17]=1; 
					basicSetupArray_a3p250[18]=0; 
					
					basicSetupArray_a3p250[64]=0;
					basicSetupArray_a3p250[65]=1;
					basicSetupArray_a3p250[66]=0;
					basicSetupArray_a3p250[67]=0;
					basicSetupArray_a3p250[68]=1;
					basicSetupArray_a3p250[69]=0; 
					basicSetupArray_a3p250[70]=1; 
					basicSetupArray_a3p250[71]=0; 
					
					basicSetupArray_a3p250[117]=0;
					basicSetupArray_a3p250[118]=1;
					basicSetupArray_a3p250[119]=0;
					basicSetupArray_a3p250[120]=0;
					basicSetupArray_a3p250[121]=1;
					basicSetupArray_a3p250[122]=0; 
					basicSetupArray_a3p250[123]=1; 
					basicSetupArray_a3p250[124]=0; 					
				...
				else
				{
					...
					basicSetupArray_a3p250[12]=1;
					basicSetupArray_a3p250[13]=0;
					basicSetupArray_a3p250[14]=1;
					basicSetupArray_a3p250[15]=0;
					basicSetupArray_a3p250[16]=1; 
					basicSetupArray_a3p250[17]=1; 
					basicSetupArray_a3p250[18]=0; 
					...
					basicSetupArray_a3p250[65]=1;
					basicSetupArray_a3p250[66]=0;
					basicSetupArray_a3p250[67]=1;
					basicSetupArray_a3p250[68]=0;
					basicSetupArray_a3p250[69]=1; 
					basicSetupArray_a3p250[70]=1; 
					basicSetupArray_a3p250[71]=0; 
					...
					basicSetupArray_a3p250[118]=1;
					basicSetupArray_a3p250[119]=0;
					basicSetupArray_a3p250[120]=1;
					basicSetupArray_a3p250[121]=0;
					basicSetupArray_a3p250[122]=1; 
					basicSetupArray_a3p250[123]=1; 
					basicSetupArray_a3p250[124]=0;
				}
...
//				}
  ...
  fprintf(file,"Download HPTDCControl_1 finished!\n");
  fprintSDR_TDI(file);
  fprintSDR_TDO(file);
  fprint_mask(file); 
  check_data(file);
...
//				}
  ...
  fprintf(file,"Download HPTDCControl_2 finished!\n");
  fprintSDR_TDI(file);
  fprintSDR_TDO(file);
  fprint_mask(file); 
  check_data(file);
...
//				}
  ...
  fprintf(file,"Download HPTDCControl_3 finished!\n");
  fprintSDR_TDI(file);
  fprintSDR_TDO(file);
  fprint_mask(file); 
  check_data(file);
...
//				}
  ...
  fprintf(file,"Download HPTDCControl_4 finished!\n");
  fprintSDR_TDI(file);
  fprintSDR_TDO(file);
  fprint_mask(file); 
  check_data(file);
...
//				}
  ...
  fprintf(file,"Download HPTDCControl_5 finished!\n");
  fprintSDR_TDI(file);
  fprintSDR_TDO(file);
  fprint_mask(file); 
  check_data(file);
...
//				else instr = HPTDCBYPASS;
  ...
  fprintf(file,"Download HPTDCControl_6 finished!\n");
  fprintSDR_TDI(file);
  fprintSDR_TDO(file);
  fprint_mask(file); 
  check_data(file);
    ...
    if (SVFFile = fopen(path, "w")) {
      ...
      if (mezzCardsOn) {
        for (i = MAXNUMBERMEZZANINE-1; i >= 0; i--) {
          if (CSMSetupArray[TDCENABLES+i] == 1) {
//Modified by Xiangting
            IntToBinary(HPTDCIDCODE, instrLength, HPTDCINSTLENGTH, instrArray, JTAGINSTRLENGTH);
            instrLength += HPTDCINSTLENGTH;
      ...
      if (mezzCardsOn) {
        for (i = MAXNUMBERMEZZANINE-1; i >= 0; i--) {
          if (CSMSetupArray[TDCENABLES+i] == 1) {
            ...
            IntToBinary(0, dataLength, 32, dataArray, MAXJTAGARRAY);
            for (j = 0; j < 32; j++) maskArray[dataLength++] = 1;
            WriteJTAGDataToActionFile(32, HPTDCOffset[i]);
            A3P250Offset[i] = dataLength;
            // IntToBinary(AMT3ID, dataLength, 32, dataArray, MAXJTAGARRAY);
            IntToBinary(0, dataLength, 32, dataArray, MAXJTAGARRAY);
            for (j = 0; j < 32; j++) maskArray[dataLength++] = 1;
