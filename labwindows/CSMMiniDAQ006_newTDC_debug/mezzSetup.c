...
void LoadTDCSetup0Array(void){
  ...
  IntToReversedBinary(TDC_ENABLE_8B108,TDC_ENABLE_8B108_INDEX,1,TDC_setup_array,TDC_SETUP_MAX_LENGTH);
...
void LoadHPTDCSetupArray(void)
{
	...
	IntToBinary(hptdc_tdc_id ,HPTDC_ID,4,basicSetupArray_h, HPTDCSETUP_LENGTH);
