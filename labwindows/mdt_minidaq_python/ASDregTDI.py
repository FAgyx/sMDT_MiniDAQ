...
filename = path + 'ASDsetup_39mV_rundown0.txt'
...
ASD0_RUND_CURR = [format(0,'b').zfill(3)]
ASD0_HYST_DAC = [''.join(reversed(format(7,'b').zfill(4)))]
ASD0_WILK_THR_DAC = [format(2,'b').zfill(3)]
ASD0_MAIN_THR_DAC = [format(108,'b').zfill(8)]
ASD0_CAP_SELECT = [format(0,'b').zfill(3)]
ASD0_CH_MASK_TST_CTRL = [format(0,'b').zfill(8)]
ASD0_VMON = [format(0,'b').zfill(2)]
ASD0_setup = [ASD0_CHANNEL_0_MODE, ASD0_CHANNEL_1_MODE, ASD0_CHANNEL_2_MODE,
                   ASD0_CHANNEL_3_MODE,
                   ASD0_CHANNEL_4_MODE, ASD0_CHANNEL_5_MODE, ASD0_CHANNEL_6_MODE,
                   ASD0_CHANNEL_7_MODE,
                   ASD0_CHIP_MODE, ASD0_DEADTIME, ASD0_INT_GATE, ASD0_RUND_CURR, ASD0_HYST_DAC,
                   ASD0_WILK_THR_DAC, ASD0_MAIN_THR_DAC, ASD0_CAP_SELECT, ASD0_CH_MASK_TST_CTRL,
                   ASD0_VMON]
asd_bin_str = ''
for s in ASD0_setup:
