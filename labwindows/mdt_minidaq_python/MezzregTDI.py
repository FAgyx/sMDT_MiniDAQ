...
ASD1_CHANNEL_0_MODE = [format(0, 'b').zfill(2)]
ASD1_CHANNEL_1_MODE = [format(0, 'b').zfill(2)]
ASD1_CHANNEL_2_MODE = [format(0, 'b').zfill(2)]
ASD1_CHANNEL_3_MODE = [format(0, 'b').zfill(2)]
ASD1_CHANNEL_4_MODE = [format(0, 'b').zfill(2)]
ASD1_CHANNEL_5_MODE = [format(0, 'b').zfill(2)]
ASD1_CHANNEL_6_MODE = [format(0, 'b').zfill(2)]
ASD1_CHANNEL_7_MODE = [format(0, 'b').zfill(2)]
