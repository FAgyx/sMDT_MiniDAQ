...
file_num = 9
# user input part end
file_delay_result_name = path + '/time_delay_result.csv'
file_delay_result = open(file_delay_result_name, "w")
CHANNEL = 24
for i in range(9):
    filename = 'run00188'+str(filenamestart+i)+'_20190611'
    offset = 5*i
    ...
    file_delay_result.write(str(offset)+','+str(hit_mean)[0:8]+','+str(hit_std)[0:8]+'\n')
file_delay_result.close()