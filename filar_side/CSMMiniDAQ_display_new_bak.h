...
unsigned int DAQState, runNumber, CSMVersion, GOLAPageSize, numberOfEvent, dataAnalysisControl;
...
public:
  ...
  int nbMezzCard;
  int mezzCardEnable[MAXNUMBERMEZZANINE], lEdgeOn[MAXNUMBERMEZZANINE], tEdgeOn[MAXNUMBERMEZZANINE], pairOn[MAXNUMBERMEZZANINE];

  CollectCSMData(int filar_chnl, FILE * p_CSM_file, FILE *p_raw_file, FILE *p_log_file);
...
private:
  int filar_chnl_no, bufnr;
  int AMTDataMode0, AMTDataMode1, enables;
